...
num_pomekons = int(input())
pomekons_list = []
pomekons_set = set()

for i in range(num_pomekons) :
    pomekons_list.append(input())

pomekons_set.update(pomekons_list)

print(f"Falta(m) {151 - len(pomekons_set)} pomekon(s).")
